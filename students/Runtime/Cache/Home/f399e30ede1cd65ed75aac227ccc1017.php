...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden" onload="load()">
    ...
    <div class="app-body">
        ...
        <main class="main">
            ...
            <div class="container-fluid">
                <div class="card">
                    <form class="form-horizontal" action=<?php echo (SITE_URL_L); ?>home/index/submit method="post" name="zhiyuan">
                        ...
                        <div class="form-actions">
                            <button class="btn btn-primary" type="submit" onclick="judge(event)">提交</button>
                        </div>
                        </div>
                    </form>
                </div>
